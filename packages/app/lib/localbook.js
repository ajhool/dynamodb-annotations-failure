...
var LocalBook = /** @class */ (function () {
    function LocalBook() {
    }
    __decorate([
        dynamodb_data_mapper_annotations_1.hashKey(),
        __metadata("design:type", String)
    ], LocalBook.prototype, "id", void 0);
    __decorate([
        dynamodb_data_mapper_annotations_1.attribute(),
        __metadata("design:type", Boolean)
    ], LocalBook.prototype, "completed", void 0);
    LocalBook = __decorate([
        dynamodb_data_mapper_annotations_1.table('local_book_table')
    ], LocalBook);
    return LocalBook;
}());
exports.default = LocalBook;
//# sourceMappingURL=localbook.js.map